    ...
    return (
        <div className="space-y-8">
            <div className="text-center mb-8">
                ...
                <p className="text-gray-400 mt-2">支持 Word、PDF、Markdown 等常用文档格式互相转换</p>
            </div>

            <div className="bg-gray-900/60 rounded-2xl p-8 border border-gray-700/50">
                {/* 转换选项 */}
                <div className="mb-8">
                    <label className="block text-sm mb-3 text-gray-300">选择转换格式</label>
                            ...
                            <button
                                ...
                                className={`
                                    ...
                                    ${conversionFormat === option.key
                                        ? 'bg-gradient-to-br from-purple-500/20 to-pink-500/20 border-purple-500 text-purple-400'
                ...
                <div className="flex flex-col items-center justify-center border-2 border-dashed border-gray-600 rounded-xl p-10">
                    ...
                    <h3 className="text-xl font-semibold mb-2">上传要转换的文件</h3>
                    ...
                    <button
                        ...
                        className="px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl hover:shadow-lg transition"
                    >
                        选择文件
                    </button>
                </div>
                ...
                {/* 已选文件 */}
                {conversionFile && (
                    <div className="mt-6 p-4 rounded-lg bg-gray-800/50 border border-gray-700 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <FileText className="w-5 h-5 text-purple-400" />
                            <div>
                                <div className="font-medium">{conversionFile.name}</div>
                        ...
                        <button
                            ...
                            className="px-4 py-2 rounded-lg bg-purple-500 hover:bg-purple-600 transition text-white text-sm font-medium"
                        >
                            {isConverting ? (
                ...
                {/* 转换消息 */}
                {conversionMessage && (
                    <div className={`mt-6 p-4 rounded-lg text-center ${conversionMessage.includes('成功') ? 'bg-green-500/20 text-green-400' : 'bg-red-500/20 text-red-400'}`}>
                ...
                {/* 格式说明 */}
                <div className="mt-8 p-4 rounded-lg bg-gray-800/30 text-sm text-gray-400">
                    <p className="font-medium mb-2">转换说明：</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-gray-900/40 rounded-xl p-6 border border-gray-800">
                    ...
                    <h3 className="font-semibold mb-1">快速转换</h3>
                    <p className="text-sm text-gray-400">支持批量转换，几秒内完成</p>
                </div>
                <div className="bg-gray-900/40 rounded-xl p-6 border border-gray-800">
                    <div className="text-2xl mb-2">🔒</div>
                    <h3 className="font-semibold mb-1">安全可靠</h3>
                    <p className="text-sm text-gray-400">本地处理，保护您的隐私</p>
                </div>
                <div className="bg-gray-900/40 rounded-xl p-6 border border-gray-800">
                    <div className="text-2xl mb-2">📱</div>
                    <h3 className="font-semibold mb-1">多端支持</h3>
                    <p className="text-sm text-gray-400">支持各种设备和浏览器</p>
                </div>
            </div>
        </div>
    );

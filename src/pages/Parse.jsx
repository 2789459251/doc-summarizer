        ...
        <div className="space-y-8">
            ...
            <div className="bg-gray-900/60 rounded-2xl p-8 border border-gray-700/50">
                ...
                <div className="mt-8">
                    <label className="block text-sm mb-3 text-gray-300">
                        选择摘要粒度
                        {!hasUserSelected && (
                            <span className="inline-flex items-center gap-1 ml-2 text-xs px-2 py-0.5 rounded-full bg-cyan-500/20 text-cyan-400">
                            ...
                            <button
                                ...
                                className={`
                                    ...
                                    ${summaryLength === level.key
                                        ? 'bg-gradient-to-br from-cyan-500/20 to-blue-500/20 border-cyan-500 text-cyan-400'
                ...
                {/* 摘要结果预览 */}
                <div className="mt-8 p-6 rounded-xl border border-emerald-500/20 bg-gray-800/30">
                    <div className="flex items-center justify-between mb-4">
                        <h3 className="text-lg font-bold text-emerald-400">摘要结果</h3>
                        <span className="text-sm text-gray-400">（约 150 字符）</span>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-gray-900/40 rounded-xl p-6 border border-gray-800">
                    ...
                    <h3 className="font-semibold mb-1">简洁摘要</h3>
                    <p className="text-sm text-gray-400">快速概览核心要点，适合快速浏览</p>
                </div>
                <div className="bg-gray-900/40 rounded-xl p-6 border border-gray-800">
                    <div className="text-2xl mb-2">📄</div>
                    <h3 className="font-semibold mb-1">标准摘要</h3>
                    <p className="text-sm text-gray-400">平衡信息量与篇幅，适合一般阅读</p>
                </div>
                <div className="bg-gray-900/40 rounded-xl p-6 border border-gray-800">
                    <div className="text-2xl mb-2">📑</div>
                    <h3 className="font-semibold mb-1">详细摘要</h3>
                    <p className="text-sm text-gray-400">完整理解内容，适合深度学习</p>
                </div>
            </div>
        </div>
    );
